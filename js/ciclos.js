...
function fillCiclos(arreglo_ciclos) {
    arreglo_ciclos.forEach((element, index) => {
        $("#ciclos-container .row").append(`
            <div class="col-sm-12 col-md-6 col-lg-3 p-2 p-md-4 text-center">
                ...
                <div class="ciclos-col p-2 p-md-4 gap-5 my-0 d-flex flex-column align-items-start rounded-bottom" style="background-color: rgb(247, 247, 247);">                                              
